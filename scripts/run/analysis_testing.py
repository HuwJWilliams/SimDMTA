...
#                         iter_ls=[0, 2],
#                         save_plot=True,
#                         it0_dir=Path("/users/yhb18174/SimDMTA/results/init_RF_model/it0_test/"),
#                         underlay_it0=True,
#                         title_fontsize=24,
#                         tick_fontsize=20,
#                         label_fontsize=22,
...
#                         receptor_path=str(SCRIPTS_DIR / "docking" / "receptors" / "4bw1_5_conserved_HOH.pdbqt"),
#                         max_confs=100,
#                         save_plot=True,
